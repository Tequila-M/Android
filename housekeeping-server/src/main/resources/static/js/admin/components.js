    ...
    template: 
	  ...
	  '<header class="main-header">'+
	    '<a href="javascript:;" class="logo">'+
	      ...
	      '<span class="logo-mini"><b>家政</b></span>'+
	      '<!-- logo for regular state and mobile devices -->'+
	      '<span class="logo-lg"><b>家政预约</b></span>'+
	    '</a>'+
    ...
    data: function() {
        return {
    		menuList:[{
    			...
    			"parentName": null,
    			"name": "分类管理",
    			"url": "/admin/project/category.html",
    			"perms": null,
    			"type": 1,
    			"icon": "fa fa-navicon",
    			"orderNum": 2,
    			...
    			"parentName": null,
    			"name": "项目管理",
    			"url": "/admin/project/project.html",
    			"perms": null,
    			"type": 1,
    			...
    			"parentName": null,
    			"name": "公司管理",
    			"url": "/admin/project/teacher.html",
    			"perms": null,
    			"type": 1,
    			"icon": "fa fa-heart",
    			"orderNum": 3,
	...
	template:
	  '<footer class="main-footer">'+
	    '<div class="pull-right hidden-xs">'+
	      'Version 1.0'+
	    '</div>'+
	    '家政服务 <a href="http://www.baidu.com" target="_blank">HouseKeeping</a> '+
	  '</footer>'
});
